...
// --------------------------------------------------
#[test]
fn bustle_t() -> TestResult {
    run(&["-T", BUSTLE], "tests/expected/the-bustle.txt.T.out")
}

// --------------------------------------------------
#[test]
fn bustle_et() -> TestResult {
    run(&["-ET", BUSTLE], "tests/expected/the-bustle.txt.ET.out")
}
...
#[test]
fn all_t() -> TestResult {
    run(&[FOX, SPIDERS, BUSTLE, "-T"], "tests/expected/all.T.out")
}

// --------------------------------------------------
#[test]
fn all_eb() -> TestResult {
    run(&[FOX, SPIDERS, BUSTLE, "-Eb"], "tests/expected/all.Eb.out")
}

// --------------------------------------------------
#[test]
fn all_tb() -> TestResult {
    run(&[FOX, SPIDERS, BUSTLE, "-Tb"], "tests/expected/all.Tb.out")
}

// --------------------------------------------------
#[test]
fn all_en() -> TestResult {
    run(&[FOX, SPIDERS, BUSTLE, "-En"], "tests/expected/all.En.out")
}

// --------------------------------------------------
#[test]
fn all_tn() -> TestResult {
    run(&[FOX, SPIDERS, BUSTLE, "-Tn"], "tests/expected/all.Tn.out")
}
